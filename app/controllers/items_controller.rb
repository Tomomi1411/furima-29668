class ItemsController < ApplicationController
  ...
  def item_params
    params.require(:item).permit(:name, :explanation, :price, :area_id, :brand_id, :pref_id, :size_id, :condition, :pay_id, :days_id, :postage_type_id, :category, :trading_status, item_imgs_attributes: [:url, :id]).merge(user_id: current_user.id)
  end
end
